 ...
 */
router.post("/challenge", Web3AuthController.getChallenge);
 ...
 */
router.post("/verify", Web3AuthController.verifySignature);
 ...
 */
router.post("/refresh", Web3AuthController.refreshToken);
 ...
 */
router.get("/me", requireAuth, Web3AuthController.getCurrentUser);
